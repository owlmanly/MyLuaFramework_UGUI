...
public class Packager {
    ...
    static void HandleExampleBundle() {
        ...
        //ui框架测试
        AddBuildMap("uiprefab" + AppConst.ExtName, "*.prefab", "Assets/LuaFramework/Examples/Builds/UIPrefab");
        AddBuildMap("anim" + AppConst.ExtName, "*.*", "Assets/LuaFramework/Examples/Animation");
    }
